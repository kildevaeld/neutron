...
typedef void (^OpenUrlCompletionHandler)(NSURLRequest* __nonnull, NSError * __nullable);
...
- (void)loadRequest:(nonnull NSURLRequest*)request completionHandler: (nullable OpenUrlCompletionHandler)handler;
